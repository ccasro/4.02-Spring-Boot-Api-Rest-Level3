...
public class OrderController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<OrderResponseDTO> updateOrder(@PathVariable String id, @Valid @RequestBody OrderRequestDTO request) {
        OrderResponseDTO response = service.updateOrder(id, request);
